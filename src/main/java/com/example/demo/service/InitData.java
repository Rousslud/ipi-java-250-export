...
public class InitData {
    ...
    public void insertTestData() throws ParseException {
        ...
        Client client2 = newClient("Durand", "Jean",  "avenue Jacques Chirac", "75009", newDate("06-05-2008"), "jean.durand@email.fr", "0711223344", "Paris");
        em.persist(client2);
        
        Client client3 = newClient("Dupond", "Emile",  "Boulevard des belges", "76000", newDate("15-08-2010"), "dupondetdupond@email.fr", "0799887766", "Rouen");
        em.persist(client3);
        
        Client client4 = newClient("Dugenou", "Francis",  "Impasse du pré", "38150", newDate("27-02-2016"), "dugenouetco@email.fr", "0712349876", "Village Pommé");
        em.persist(client4);
        
        Client client5 = newClient("Dupate", "Albert",  "rue du four à pain", "12870", newDate("06-10-2012"), "dubonpate@email.fr", "0744993355", "Village gourmand");
        em.persist(client5);
    ...
    private Article newArticle(String libelle, double prix, String categorie) {
